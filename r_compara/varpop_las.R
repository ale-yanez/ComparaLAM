...
p8 <- ggplot(data = NULL, aes(x = yrs)) + 
  ...
  geom_line(aes(y = c(rep(1,42)), colour = 'Brms', linetype = '')) + #EN CASO DE QUERER UNIR CON BD MANTENGO ESTA LINEA
...
ggsave(p8, filename = "../figures/LAS/figure_11.png", width=9, height=4.5, dpi=300)
dir()
...
ggsave(p12, filename = "../figures/LAS/figure_12.png", width=9, height=4.5, dpi=300)

plot_RF <- ggarrange(p8, p12, ncol = 1, nrow = 2, align = "v", common.legend = T, legend = "bottom")
ggsave(plot_RF, filename = "../figures/LAS/figure_13.png", width=8, height=6.5, dpi=300)
...
ggsave(p14, filename = "../figures/LAS/figure_14.png", width=9, height=4.5, dpi=300)
...
ggsave(p15, filename = "../figures/LAS/figure_15.png", width=9, height=4.5, dpi=300)

plot_B <- ggarrange(p14, p15, ncol = 1, nrow = 2, align = "v", common.legend = T, legend = "bottom")
ggsave(plot_B, filename = "../figures/LAS/figure_16.png", width=8, height=6.5, dpi=300)
