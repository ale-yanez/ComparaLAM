...
length(out20$YRS)
Year <- c(out20$YRS[42],out20$YRS[41],out20$YRS[40],out20$YRS[39])
...
write.table(table, '../tables/LAS/pbrtable_1.txt', append = FALSE, sep = " ", dec = ".", row.names = TRUE, col.names = TRUE)
