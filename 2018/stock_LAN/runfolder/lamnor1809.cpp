...
void model_parameters::initializationfunction(void)
{
  ...
  log_rango1m.set_initial_value(log_s1priorm);
  log_L50h.set_initial_value(log_L50fpriorh);
  log_rango1h.set_initial_value(log_s1priorh);
  log_L50ch.set_initial_value(log_L50fpriorch);
  log_rango1ch.set_initial_value(log_s1priorch);
  log_L50cm.set_initial_value(log_L50fpriorcm);
  log_rango1cm.set_initial_value(log_s1priorcm);
 ...
 model_data(argc,argv) , function_minimizer(sz)
{
  ...
  log_L50m.allocate(1,nbloques1,0.67,1.94,optSf_fase,"log_L50m");
  log_rango1m.allocate(1,nbloques1,optSf_fase,"log_rango1m");
  log_L50h.allocate(1,nbloques1,0.67,1.94,optSf_fase,"log_L50h");
  log_rango1h.allocate(1,nbloques1,optSf_fase,"log_rango1h");
  log_L50ch.allocate(1,nbloques2,0.67,1.94,optSc_fase,"log_L50ch");
  log_rango1ch.allocate(1,nbloques2,optSc_fase,"log_rango1ch");
  log_L50cm.allocate(1,nbloques2,0.67,1.94,optSc_fase,"log_L50cm");
  log_rango1cm.allocate(1,nbloques2,optSc_fase,"log_rango1cm");
  ...
  S2.allocate(1,nbloques1,1,nedades,"S2");
    ...
    S2.initialize();
  #endif
  S3.allocate(1,nbloques2,1,nedades,"S3");
  #ifndef NO_AD_INITIALIZE
    S3.initialize();
  #endif
  S4.allocate(1,nbloques2,1,nedades,"S4");
  #ifndef NO_AD_INITIALIZE
    S4.initialize();
  #endif
  ...
  Lmf_obs.allocate(1,ntime,"Lmf_obs");
  #ifndef NO_AD_INITIALIZE
    Lmf_obs.initialize();
  #endif
  Lmf_pred.allocate(1,ntime,"Lmf_pred");
  Lhf_obs.allocate(1,ntime,"Lhf_obs");
  #ifndef NO_AD_INITIALIZE
    Lhf_obs.initialize();
  #endif
  Lhf_pred.allocate(1,ntime,"Lhf_pred");
  Lmc_obs.allocate(1,ntime,"Lmc_obs");
  #ifndef NO_AD_INITIALIZE
    Lmc_obs.initialize();
  #endif
  Lmc_pred.allocate(1,ntime,"Lmc_pred");
  Lhc_obs.allocate(1,ntime,"Lhc_obs");
  #ifndef NO_AD_INITIALIZE
    Lhc_obs.initialize();
  #endif
  Lhc_pred.allocate(1,ntime,"Lhc_pred");
