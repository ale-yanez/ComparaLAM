...
dir.2<-'~/Documents/ADMwork/IFOP/2019/Lama_model/Estatus_1910/norte/data_update/'
dir.3<-'~/Documents/ADMwork/IFOP/2019/Lama_model/Estatus_1910/norte/Lamnor1910/'


unlink(dir.3,recursive=T) #borra el dir3 del Mac
dir.create(file.path('~/Documents/ADMwork/IFOP/2019/Lama_model/Estatus_1910/norte/','Lamnor1910')) # crea el dir3 nuevo y vacío
#system('mkdir fig') otra opción
setwd(dir.2); file.copy(c('lamnor1910s6.dat', 'LAM.tpl'), dir.3)
