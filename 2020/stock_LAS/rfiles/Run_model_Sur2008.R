...
dir.2<-'~/Documents/ADMwork/IFOP/2020/Lama_model/Estatus_2008/sur/data_update/'
dir.3<-'~/Documents/ADMwork/IFOP/2020/Lama_model/Estatus_2008/sur/Lamsur2008/'


#unlink(dir.3,recursive=T) #borra el dir3 del Mac
dir.create(file.path('~/Documents/ADMwork/IFOP/2020/Lama_model/Estatus_2008/sur/','Lamsur2008')) # crea el dir3 nuevo y vacío
#system('mkdir fig') otra opción
setwd(dir.2); file.copy(c('lamsur2008s5.dat', 'LAmS.tpl'), dir.3)
...
system('mv lamsur2008s5.dat lamsur2008.dat')
...
#system('cp -)
writeData(paste("lamsur2008s8.dat",sep=""), data.1, append=FALSE)
system('mv lamsur2008s8.dat lamsur2008s5.dat')
