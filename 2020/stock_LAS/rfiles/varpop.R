...
out2 <- read.admb("~/Documents/ADMwork/IFOP/2019/Lama_model/Cons_2003/sur/Lamsur2003/LAM_sur2003")
...
std2 <- read.table('~/Documents/ADMwork/IFOP/2019/Lama_model/Cons_2003/sur/Lamsur2003/LAM_sur2003.std', header=T, sep="", na="NA", fill=T)
